...
window.XBOARD_TRANSLATIONS['en-US'] = {
  ...
  "plugin": {
    ...
    "author": "Author",
    "runtime": {
      "pageDescription": "View plugin details and manage runtime pages.",
      "notFoundTitle": "Plugin Not Found",
      "notFoundDescription": "The requested plugin does not exist or has been removed.",
      "backToPluginList": "Back to Plugin List",
      "disabledDescription": "This plugin is currently disabled. Enable it from the plugin list to access its pages.",
      "pageNotFoundTitle": "Page Not Found",
      "pageNotFoundDescription": "This plugin does not provide a page at the requested path.",
      ...
      "openMenuPage": "Open Page",
      "pluginMenuPageDescription": "This page is registered by the plugin. Custom UI can be loaded here when the plugin implements it.",
