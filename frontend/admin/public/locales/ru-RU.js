  ...
  "settings": {
    ...
    "subscribe": {
      ...
      "surplus_traffic_ratio_enable": {
        "title": "Учитывать остаток трафика при зачете",
        "description": "При включении зачет при апгрейде берет минимум из остатка цикла и доли оставшегося трафика. Не связано со сбросом трафика после апгрейда."
      },
      "new_order_event": {
