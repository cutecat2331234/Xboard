export default {
  ...
  dashboard: {
    ...
    copyLink: "購読リンクをコピー",
    announcements: "お知らせ",
    unpaidOrders: "未払いの注文があります",
    payNow: "今すぐ支払う",
    openTickets: "{count} 件のチケットが処理中です",
    goView: "今すぐ確認",
    ...
    deviceLimit: 'デバイス上限：{count}台',
    speedLimit: '速度制限：{speed} Mbps',
    invitedUsers: '{count}人を招待しました',
    noSubscribeUrl: '有効な購読リンクがありません。先にプランを購入してください。',
    protocolTypes: {
      auto: "自動",
      anytls: "Anytls",
      vless: "Vless",
  ...
  order: {
    ...
    redirectPaymentHint: "新しいブラウザタブで支払いを完了してください。支払い成功後、このページは自動的に更新されます。",
    redirectPopupBlocked: "ポップアップがブロックされました。このサイトのポップアップを許可してから再試行してください。",
    paymentMethod: "支払い方法",
    totalTitle: "注文合計",
    checkout: "お支払い",
  ...
  profile: {
    ...
    resetConfirm: "購読リンクとトークンをリセットしますか？既存のクライアントは購読の更新が必要です。",
    accountInfo: "アカウント情報",
