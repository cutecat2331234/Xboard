export default {
  ...
  dashboard: {
    ...
    unpaidOrders: "Vẫn còn đơn hàng chưa thanh toán",
    payNow: "Thanh toán ngay",
    openTickets: "{count} phiếu hỗ trợ đang xử lý",
    goView: "Xem ngay",
    ...
    deviceLimit: 'Giới hạn thiết bị: {count}',
    speedLimit: 'Giới hạn tốc độ: {speed} Mbps',
    invitedUsers: 'Bạn đã mời {count} người dùng',
    noSubscribeUrl: 'Chưa có liên kết đăng ký. Vui lòng mua gói trước.',
    protocolTypes: {
      auto: "Tự động",
      anytls: "Anytls",
      vless: "Vless",
  ...
  errors: {
    ...
    paymentMethodLocked: 'Vui lòng hủy đơn và tạo đơn mới để đổi phương thức thanh toán',
    ...
    oldPasswordWrong: 'Mật khẩu hiện tại không đúng',
    passwordTooShort: 'Mật khẩu phải có ít nhất 8 ký tự',
    saveFailed: 'Lưu thất bại',
    transferFailed: 'Chuyển tiền thất bại',
    telegramNotBound: 'Tài khoản Telegram chưa được liên kết',
    telegramUnbindFailed: 'Failed to unlink Telegram',
    inviteCodeLimit: 'Đã đạt số lượng mã mời tối đa',
  ...
  profile: {
    ...
    balanceHint: "Số dư tài khoản (Chỉ dùng để thanh toán)",
    email: "E-mail",
    uuid: "UUID",
