export default {
  ...
  dashboard: {
    ...
    unpaidOrders: 'There are still unpaid orders',
    payNow: 'Pay Now',
  ...
  errors: {
    ...
    sessionNotFound: 'Session not found or already revoked.',
    ...
    couponUsedUp: 'This coupon is no longer available',
    couponPlanMismatch: 'This coupon cannot be used for this subscription',
    ...
    openTicketExists: 'You already have an open ticket. Close it before creating a new one.',
    ...
    ticketSystemDisabled: 'The ticket system is disabled',
    withdrawTicketCloseForbidden: 'Withdraw tickets cannot be closed. Please contact support.',
  ...
  ticket: {
    ...
    closeConfirm: 'Close this ticket? You will not be able to reply after closing.',
  ...
  profile: {
    wallet: 'My Wallet',
    balanceHint: 'Account Balance (For billing only)',
    email: 'Email',
    uuid: 'UUID',
    ...
    confirmPasswordPh: 'Please enter the new password',
    oldPasswordPh: 'Please enter the old password',
    newPasswordPh: 'Please enter the new password',
    notify: 'Notification',
    remindExpire: 'Subscription expiration email reminder',
    remindTraffic: 'Insufficient transfer data email alert',
    resetSubscribe: 'Reset Subscription',
    resetDesc: 'Reset your subscription credentials if they have been leaked.',
    resetConfirm: 'Reset your subscription link and token? Existing clients will need to update their subscription.',
    resetSuccessWithUrl: 'Subscription reset. Import this new URL into your client:\n\n{url}',
    accountInfo: 'Account',
