export default {
  ...
  dashboard: {
    ...
    copyLink: "구독 링크 복사",
    announcements: "공지사항",
    unpaidOrders: "아직 결제하지 않은 주문이 있습니다",
    payNow: "지금 결제",
    openTickets: "{count}건의 티켓이 처리 중입니다",
    goView: "지금 보기",
    ...
    popupNoticeTags: "팝업",
    deviceLimit: '기기 제한: {count}대',
    speedLimit: '속도 제한: {speed} Mbps',
    invitedUsers: '{count}명 초대함',
    noSubscribeUrl: '유효한 구독 링크가 없습니다. 먼저 요금제를 구매하세요.',
    protocolTypes: {
      auto: "자동",
      anytls: "Anytls",
      vless: "Vless",
