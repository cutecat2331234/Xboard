...
const MESSAGE_MAP: Record<string, string> = {
  ...
  'Email can not be empty': 'auth.validation.email_required',
  'Email format is incorrect': 'auth.validation.email_format',
  'Password can not be empty': 'auth.validation.password_required',
  '邮箱不能为空': 'auth.validation.email_required',
  '邮箱格式不正确': 'auth.validation.email_format',
  '密码不能为空': 'auth.validation.password_required',
  'Incorrect format of expiration reminder': 'profile.validation.remind_expire_format',
  'Incorrect traffic alert format': 'profile.validation.remind_traffic_format',
  '过期提醒参数有误': 'profile.validation.remind_expire_format',
  '流量提醒参数有误': 'profile.validation.remind_traffic_format',
  'Old password cannot be empty': 'profile.validation.old_password_required',
  'New password cannot be empty': 'profile.validation.new_password_required',
  '旧密码不能为空': 'profile.validation.old_password_required',
  '新密码不能为空': 'profile.validation.new_password_required',
  'The withdrawal method cannot be empty': 'errors.withdrawMethodEmpty',
  'The withdrawal account cannot be empty': 'errors.withdrawAccountEmpty',
  '提现方式不能为空': 'errors.withdrawMethodEmpty',
  '提现账号不能为空': 'errors.withdrawAccountEmpty',
  'Wrong plan period': 'errors.wrongPlanPeriod',
  '套餐周期参数有误': 'errors.wrongPlanPeriod',
}
