...
class ServerSave extends FormRequest
{
    ...
    {
        return [
            'type.required' => __('Node type cannot be empty'),
            'type.in' => __('Invalid node type specified'),
            ...
            'rate_time_ranges.*.start.date_format' => __('Rate time range start time format is invalid (use HH:MM)'),
            'rate_time_ranges.*.end.date_format' => __('Rate time range end time format is invalid (use HH:MM)'),
            'rate_time_ranges.*.rate.numeric' => __('Rate multiplier format is invalid'),
            'rate_time_ranges.*.rate.min' => __('Rate multiplier cannot be less than 0'),
