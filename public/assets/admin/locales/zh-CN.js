...
window.XBOARD_TRANSLATIONS['zh-CN'] = {
  ...
  "plugin": {
    ...
    "author": "作者",
    "runtime": {
      "pageDescription": "查看插件详情并管理运行时页面。",
      "notFoundTitle": "插件未找到",
      "notFoundDescription": "请求的插件不存在或已被移除。",
      "backToPluginList": "返回插件列表",
      "disabledDescription": "此插件当前已禁用。请先在插件列表中启用后再访问其页面。",
      "pageNotFoundTitle": "页面未找到",
      "pageNotFoundDescription": "此插件未提供所请求路径的页面。",
      "backToOverview": "返回概览",
      "overview": "概览",
      "settings": "设置",
      "metadataTitle": "插件信息",
      ...
      "openMenuPage": "打开页面",
      "pluginMenuPageDescription": "此页面由插件注册。当插件实现自定义界面时，可在此加载。",
