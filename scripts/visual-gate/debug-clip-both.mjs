...
for (const [name, base] of [['7001', 'http://43.248.77.134:7001'], ['7002', 'http://43.248.77.134:7002']]) {
  const page = await browser.newPage({ viewport: { width: 1280, height: 800 } })
  await page.goto(`${base}/d7f5c92b#/sign-in`, { waitUntil: 'domcontentloaded', timeout: 90000 })
  await page.evaluate(() => {
  ...
  await page.goto(`${base}/d7f5c92b#/config/system/safe`, { waitUntil: 'domcontentloaded', timeout: 90000 })
