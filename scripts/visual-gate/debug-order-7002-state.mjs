...
for (let i = 0; i < 3; i++) {
  try {
    await page.goto(`http://43.248.77.134:7002/${securePath}#/sign-in`, { waitUntil: 'networkidle', timeout: 60000 })
    await page.locator('input[type="email"], input[name="email"]').first().fill('admin@xboard.local', { timeout: 30000 })
    break
  } catch {
...
await page.goto(`http://43.248.77.134:7002/${securePath}#/finance/order`, { waitUntil: 'networkidle', timeout: 60000 })
