...
await probe('http://43.248.77.134:7001', 'invite')
await probe('http://43.248.77.134:7002', 'invite')
await probe('http://43.248.77.134:7001', 'dashboard')
await probe('http://43.248.77.134:7002', 'dashboard')
