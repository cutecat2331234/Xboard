...
await box('http://43.248.77.134:7001', 'login')
await box('http://43.248.77.134:7002', 'login')
await box('http://43.248.77.134:7001', 'register')
await box('http://43.248.77.134:7002', 'register')
