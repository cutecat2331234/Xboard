...
const refBase = process.env.REF_BASE || 'http://43.248.77.134:7001'
const cmpBase = process.env.CMP_BASE || 'http://43.248.77.134:7002'
const side = process.env.SIDE || 'user'
const securePath = process.env.SECURE_PATH || 'd7f5c92b'
const adminEmail = process.env.ADMIN_EMAIL || 'admin@xboard.local'
const adminPassword = process.env.ADMIN_PASSWORD || 'Xboard@2026'
