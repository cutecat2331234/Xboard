...
const tradeNo = await apiFixtures('http://43.248.77.134:7001')
console.log('tradeNo', tradeNo)
const ref = await shot('http://43.248.77.134:7001', '7001', tradeNo)
const cmp = await shot('http://43.248.77.134:7002', '7002', tradeNo)
