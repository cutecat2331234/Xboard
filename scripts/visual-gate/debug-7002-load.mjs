...
await page.goto('http://127.0.0.1:7002/#/sign-in', { waitUntil: 'domcontentloaded', timeout: 90000 })
await page.evaluate(() => {
...
await page.goto('http://127.0.0.1:7002/#/config/system/safe', { waitUntil: 'domcontentloaded', timeout: 90000 })
