...
supervisorctl start xboard-octane-legacy xboard-octane-new || true
supervisorctl status xboard-octane-new | grep -q RUNNING || supervisorctl start xboard-octane-new
sleep 10
