 ...
 * Usage: node scripts/capture-ui-spec.mjs [--base=http://43.248.77.134:7001] [--side=user|admin]
 */
...
const base = args.base || 'http://43.248.77.134:7001'
const side = args.side || 'user'
const securePath = args['secure-path'] || 'd7f5c92b'
const adminEmail = args['admin-email'] || 'admin@xboard.local'
const adminPassword = args['admin-password'] || 'Xboard@2026'
